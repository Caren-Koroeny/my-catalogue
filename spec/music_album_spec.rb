...
RSpec.describe MusicAlbum do
  ...
  describe '#can_be_archived?' do
    it 'should return true if publish_date is older than 10 years and on_spotify is true' do
      album = MusicAlbum.new(id: 1, genre: genre, author: 'Artist', source: 'CD', label: 'Label', publish_date: Date.new(2010, 1, 1), on_spotify: true)
    ...
    it 'should return false if on_spotify is false' do
      album = MusicAlbum.new(id: 1, genre: genre, author: 'Artist', source: 'CD', label: 'Label', publish_date: Date.new(2010, 1, 1), on_spotify: false)
